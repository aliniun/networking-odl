...
ODL_FIREWALL = 'firewall'
ODL_FIREWALLS = 'firewalls'
ODL_FIREWALL_POLICY = 'firewall_policy'
ODL_FIREWALL_POLICYS = 'firewall_policies'
ODL_FIREWALL_RULE = 'firewall_rule'
ODL_FIREWALL_RULES = 'firewall_rules'
...
RESOURCE_URL_MAPPINGS = {
    ...
    ODL_LOADBALANCER: "lbaas/%s" % ODL_LOADBALANCERS,
    ODL_LISTENER: "lbaas/%s" % ODL_LISTENERS,
    ODL_POOL: "lbaas/%s" % ODL_POOLS,
    ODL_HEALTHMONITOR: "lbaas/%s" % ODL_HEALTHMONITORS,
    ODL_FIREWALL: "fw/%s" % ODL_FIREWALLS,
    ODL_FIREWALL_POLICY: "fw/%s" % ODL_FIREWALL_POLICYS,
    ODL_FIREWALL_RULE: "fw/%s" % ODL_FIREWALL_RULES,
}
